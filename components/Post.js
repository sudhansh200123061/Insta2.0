...
function Post({id, username, userImage, img, caption}) {
  ...
  return (
    <div className='bg-white my-7 border rouded-sm'>
        ...
        {session && (
          <div>
            <form className='flex items-center p-4' action="">
              ...
              <input value={comment} onChange={e => setComment(e.target.value)} className='border-none flex-1 focus:ring-0 outline-none' type="text" placeholder='Add a comment..'/>
